...
| `ZCL_UTILITY` | Class — `get_sfdc_token( )` · `parse_sfdc_token_response( )` (pure) | `src/zcl_utility.clas.abap` | ZARE002 · ZARI002 | 🟨 code ส่งแล้ว 2026-09-21 |
| `ZCL_UTILITY` testclasses | parse token / error response — ไม่ต่อ SFDC | `src/zcl_utility.clas.testclasses.abap` | | 🟨 4 test |
